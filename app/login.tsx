...
export default function LoginPage() {
  ...
  const handleSignUp = () => {
    console.log('Sign Up Pressed from Login Page');
    router.replace('/signup'); // Navigate to the signup page
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <TouchableOpacity style={styles.googleButton} onPress={handleGoogleSignIn}>
          <Image
            source={{ uri: 'https://cdn-icons-png.flaticon.com/512/281/281764.png' }} // Generic Google icon
...
const styles = StyleSheet.create({
  ...
  loginButton: { // Style for the Login button (blue)
    width: '100%',
    height: height * 0.055,
  ...
  signupContainer: { // Renamed from loginContainer for clarity in LoginPage
    flexDirection: 'row',
    marginTop: height * 0.03,
  },
  signupText: { // Renamed from loginText
    color: '#333',
    fontSize: width * 0.038,
  },
  signupLink: { // Renamed from loginLink
    color: '#28a745',
    fontSize: width * 0.038,
    fontWeight: 'bold',
  },
